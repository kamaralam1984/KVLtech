...
const PRODUCTS = [
  ...
  },
  {
    ...
    category: "SOFTWARE" as const, photo: "/photos/office-meeting.jpg", gallery: ["/photos/office-meeting.jpg"],
  ...
  },
  {
    ...
    category: "SOFTWARE" as const, photo: "/photos/person-laptop.jpg", gallery: ["/photos/person-laptop.jpg"],
